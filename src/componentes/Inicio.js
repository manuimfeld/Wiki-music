...
import ListaArtistas from './ListaArtistas'
  ...
  return (
    <>
      {/* Header */}
      <Buscador buscar={buscar} setBuscar={setBuscar} setArtistas={setArtistas} errores={errores} setErrores={setErrores} setCargando={setCargando}/>
      
      {/* Si no hay artistas y errores/cargando son false, se muestra la página principal*/}
      ...
      /* Hay artistas pero si cargando es true, se muestra el componente Cargando, después se muestra el componente ListaArtistas*/
